...
\title{
	%\vspace{-1in} 	
	\usefont{OT1}{bch}{b}{n}
	\normalfont \normalsize \textsc{\color{blue}Instituto Tecnológico de Buenos Aires} \\ [25pt]
	\horrule{2pt} \\[0.4cm]
	\huge \color{magenta}Assignment $N^o 1$ \\
	\horrule{2pt} \\[0cm]
\author{\color{teal}Group 2}
\text{\color{teal}Electrónica 3 - 2018}
}
